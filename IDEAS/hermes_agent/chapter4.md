...
Creating the AI Platform "Today we stop preparing and start building."
...
Internet │ ▼ Cloudflare / DNS │ ▼ HTTPS (443) │ ▼ Traefik Reverse Proxy │ ┌──────────┼──────────┐ │ │ │ ▼ ▼ ▼ Hermes n8n OpenHands │ ▼ Internal Docker Network │ ┌────┴─────────────┐ ▼ ▼ PostgreSQL Qdrant
...
Type Name Target A ai VPS IP A hermes VPS IP A n8n VPS IP A grafana VPS IP A api VPS IP
...
4.14 Health Checks
Every service should expose a health endpoint where possible.
